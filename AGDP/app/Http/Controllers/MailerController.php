...
class MaileController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('mailer.listaM', compact('mail'));
    }
    ...
    public function create()
    {
        ...
        $city = CM::all();
        $mail = MailE::all();
        return view('mailer.nuevaCSO', compact('folder', 'storagew', 'city', 'mail'));
    }
    ...
    public function edit($idMail)
    {
        ...
        $storagew = SWM::all();
        $city = CM::all();
        return view('mailer.updateM', compact('folder','storagew','city'));
    }
