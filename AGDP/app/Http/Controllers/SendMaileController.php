...
class SendMaileController extends Controller
{
    /**
    ...
    public function index()
    {
       // $mail = MailE::with('Folder', 'StorageWay', 'City');
        $mail = MailE::all()->where('typeMail',0);
        return view('SendMaile.lista', compact('mail'));
    }
    ...
    public function create()
    {
        ...
        $client = CL::all();
        $mail = MailE::all();
        return view('SendMaile.create', compact('folder', 'storagew', 'city','client','mail'));
    }
    ...
    public function files()
    {
        ...
        $city = CM::all();
        $mail = MailE::all();
        return view('SendMaile.files', compact('folder', 'storagew', 'city', 'mail'));
    }
    ...
    public function show()
    {
        ...
        $storagew = SWM::all();
        $city = CM::all();
        return view('SendMaile.show', compact('folder','storagew','city'));
    }
    ...
    public function edit()
    {
        ...
        $storagew = SWM::all();
        $city = CM::all();
        return view('SendMaile.edit', compact('folder','storagew','city'));
    }
