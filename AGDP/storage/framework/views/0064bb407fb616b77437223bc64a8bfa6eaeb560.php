	...
	<div class="col-sm-12 col-md-8 col-lg-6 text-left">
		...
		<div>
			<div class="form-group row justify-content-center">
				...
				<p for="" class="col-sm-6 text-left"><?php echo e(Auth::user()->namePerson); ?>  <?php echo e(Auth::user()->lastnamePerson); ?></p>
			</div>
			
			<div class="form-group row justify-content-center">
				<p for="" class="col-sm-6 text-left"><strong>Número de documento: </strong> </p>
				<p for="" class="col-sm-6 text-left"><?php echo e(Auth::user()->codPerson); ?></p>
			</div>

			<div class="form-group row justify-content-center">
				<p for="" class="col-sm-6 text-left"><strong>Correo electrónico:</strong> </p>
				<p for="" class="col-sm-6 text-left"><?php echo e(Auth::user()->email); ?></p>
			</div>
			<div class="form-group row justify-content-center">
				<p for="" class="col-sm-6 text-left"><strong>Área de trabajo:</strong> </p>
				<p for="" class="col-sm-6 text-left"><?php echo e(Auth::user()->Dependency->nameDependency); ?></p>
				
			</div>
			<div class="form-group row justify-content-center">
				<p for="" class="col-sm-6 text-left"><strong>Cargo:</strong> </p>
				<p for="" class="col-sm-6 text-left"><?php echo e(Auth::user()->TypePerson->nameTypePerson); ?></p>				
			</div>
			...
			<div>
				<a href="<?php echo e(route('mainboard')); ?>" class="col-sm-6 text-left">Home</a>
			</div>
	</div>
</div>
