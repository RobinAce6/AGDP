...
<div class="wrapper-login">
    <div class="container">
        <form class="needs-validation" data-parsley-validate  method="POST"  action="<?php echo e(route('login')); ?>">
        <?php echo e(csrf_field()); ?>
            ...
            <div class="row">
                <div class="col-xs-12 col-xs-offset-0 col-md-4 col-md-offset-4 login text-center">
                    ...
                    <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?> text-left">
                        <input type="email" class="form-control" aria-describedby="emailHelp" placeholder="Email Empresarial" required data-parsley-required-message="Este campo es obligatorio" data-parsley-type-message="Ingrese un correo electrónico válido" value="<?php echo e(old('email')); ?>" name="email">
                    ...
                    <div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?> text-left password">
