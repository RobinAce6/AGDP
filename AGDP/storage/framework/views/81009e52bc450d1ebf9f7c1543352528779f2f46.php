					...
					<div id="sent" class="sent d-none">
						<form  class="needs-validation" novalidate>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12 col-md-4">
									...
									<div class="col-sm-10 col-lg-12">
		                                ...
		                                <?php $__currentLoopData = $folder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Proyecto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		                                    <option value="<?php echo e($Proyecto->idFolder); ?>"><?php echo e($Proyecto->nameFolder); ?></option>
							...
							<div class="text-center">
								...
								<a href="<?php echo e(route('maile.listM')); ?>" class="btn btn-light">Cancelar</a>
							</div>
						</form>
					</div>
