					...
					<div class="top_tiles">
						<div class="row">
							...
							<div class="animated flipInY col-lg-4 col-lg-offset-2 col-md-offset-2  col-md-4 col-sm-offset-0  col-sm-6 col-xs-offset-0  col-xs-12">
								<a href="<?php echo e(route('listM')); ?>"><div class="tile-stats">
						...
						<div class="row">
							<div class="animated flipInY col-lg-4 col-lg-offset-2 col-md-offset-2  col-md-4 col-sm-offset-0  col-sm-6 col-xs-offset-0  col-xs-12">
								<a href="<?php echo e(route('listaC')); ?>"><div class="tile-stats">
							...
							<div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
								<a href="<?php echo e(route('lista')); ?>"><div class="tile-stats">
