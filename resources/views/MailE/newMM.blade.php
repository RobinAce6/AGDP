					...
					<div id="sent" class="sent d-none">
						<form  class="needs-validation" novalidate>
							...
							<div class="col-sm-12 col-md-4"> 
		                        ...
		                        <div class="col-sm-10 col-lg-12">
		                           <select class="form-control custom-select" name="originCity" required>
		                               <option id="idCity" value="">Seleccione la ciudad Origen</option>
		                               <option id="city2" value="">Seleccione la ciudad Origen</option>
		                           </select>
		                        </div>
		                  	</div>
							</div>
