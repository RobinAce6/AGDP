            ...
            <div>
               <div class="card" style="width: 30rem;">
                  <div class="card-header" id="headingOne">
                     ...
                     {{$Storage->name}}
                     <a data-toggle="modal" data-target="#exampleModalCenter-{{$Storage->id}}"><i class="fas fa-pencil-alt float-right"></i></a>
                     </h6>
                  </div>
                  <div class="modal fade" id="exampleModalCenter-{{$Storage->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <form class="login100-form validate-form" method="POST"  action="{{ route('updateSW', [$Storage->id]) }}">
                                  {{ csrf_field() }}
                                  
                                 <input type="text" class="form-control" name="name" value="{{ $Storage->name }}" required>
